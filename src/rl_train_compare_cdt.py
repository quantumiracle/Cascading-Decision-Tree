...
if __name__ == '__main__':
    ...
    parser.add_argument('--fl_depth',
                    dest='feature_learning_depth',
                    action='store',
                    default=2)

    parser.add_argument('--dm_depth',
                    dest='decision_depth',
                    action='store',
                    default=2)
    ...
    filename = "./cdt/cdt_rl_train_compare.json"
    ...
    rl_confs[EnvName]["learner_args"]["feature_learning_depth"]=int(args.feature_learning_depth)
    rl_confs[EnvName]["learner_args"]["decision_depth"]=int(args.decision_depth)

    # add id 
    rl_confs[EnvName]["train_confs"]["model_path"] = rl_confs[EnvName]["train_confs"]["model_path"]+'_'+args.feature_learning_depth+args.decision_depth+'_'+args.id
    rl_confs[EnvName]["train_confs"]["log_path"] = rl_confs[EnvName]["train_confs"]["log_path"]+'_'+args.feature_learning_depth+args.decision_depth+'_'+args.id
